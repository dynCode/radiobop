...
(function(){
    ...
    module.controller('AppController', function ($scope, $http, $window, $rootScope, $sce) {
		var apiURL = "http://radiobop.co.za/app/app.php";
        $scope.streamURL = $sce.trustAsResourceUrl('https://capeant.antfarm.co.za:8000/ptafm');
        ...
        $scope.playAudio = function() {
            var audioUrl = "https://capeant.antfarm.co.za:8000/ptafm";
