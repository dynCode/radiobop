...
(function(){
    ...
    module.controller('AppController', function ($scope, $http, $window, $rootScope, $sce) {
        ...
        $scope.streamURL = $sce.trustAsResourceUrl('https://live.urbanza.co.za/radio/8020/radiobop?1565862890');
        ...
        $scope.playAudio = function() {
            var audioUrl = "https://live.urbanza.co.za/radio/8020/radiobop?1565862890";
